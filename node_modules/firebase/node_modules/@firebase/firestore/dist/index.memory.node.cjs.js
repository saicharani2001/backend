...
var version = "7.22.1-alpha.96ae6a5fe";
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ResourcePath = /** @class */ (function (_super) {
    ...
    ResourcePath.fromString = function () {
        ...
        // for legacy reasons and should not be used frequently).
        var segments = [];
        for (var _e = 0, pathComponents_1 = pathComponents; _e < pathComponents_1.length; _e++) {
            var path = pathComponents_1[_e];
            if (path.indexOf('//') >= 0) {
 ...
 */
var BundleConverter = /** @class */ (function () {
    function BundleConverter(serializer) {
        this.serializer = serializer;
    }
    BundleConverter.prototype.toDocumentKey = function (name) {
        return fromName(this.serializer, name);
    };
    /**
     * Converts a BundleDocument to a MaybeDocument.
     */
    BundleConverter.prototype.toMaybeDocument = function (bundledDoc) {
        if (bundledDoc.metadata.exists) {
            return fromDocument(this.serializer, bundledDoc.document, false);
        }
        else {
            return new NoDocument(this.toDocumentKey(bundledDoc.metadata.name), this.toSnapshotVersion(bundledDoc.metadata.readTime));
        }
    };
    BundleConverter.prototype.toSnapshotVersion = function (time) {
...
var BundleLoader = /** @class */ (function () {
    ...
    BundleLoader.prototype.getQueryDocumentMapping = function (documents) {
        ...
        var bundleConverter = new BundleConverter(this.serializer);
        for (var _i = 0, documents_1 = documents; _i < documents_1.length; _i++) {
            var bundleDoc = documents_1[_i];
            if (bundleDoc.metadata.queries) {
                var documentKey = bundleConverter.toDocumentKey(bundleDoc.metadata.name);
                for (var _e = 0, _f = bundleDoc.metadata.queries; _e < _f.length; _e++) {
                    var queryName = _f[_e];
    ...
    BundleLoader.prototype.complete = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var changedDocuments, queryDocumentMap, _i, _e, q;
            return tslib.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, applyBundleDocuments(this.localStore, this.documents, this.bundleMetadata.id)];
                    case 1:
                        changedDocuments = _f.sent();
                        queryDocumentMap = this.getQueryDocumentMapping(this.documents);
                        _i = 0, _e = this.queries;
                        _f.label = 2;
                    case 2:
                        if (!(_i < _e.length)) return [3 /*break*/, 5];
                        q = _e[_i];
                        return [4 /*yield*/, saveNamedQuery(this.localStore, q, queryDocumentMap.get(q.name))];
                    case 3:
                        _f.sent();
                        _f.label = 4;
                    case 4:
 ...
 * queue.
 */
function applyBundleDocuments(localStore, documents, bundleName) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var localStoreImpl, bundleConverter, documentKeys, documentMap, versionMap, _i, documents_2, bundleDoc, documentKey, documentBuffer, umbrellaTargetData;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    localStoreImpl = debugCast(localStore);
                    bundleConverter = new BundleConverter(localStoreImpl.serializer);
                    documentKeys = documentKeySet();
                    documentMap = maybeDocumentMap();
                    versionMap = documentVersionMap();
                    for (_i = 0, documents_2 = documents; _i < documents_2.length; _i++) {
                        bundleDoc = documents_2[_i];
                        documentKey = bundleConverter.toDocumentKey(bundleDoc.metadata.name);
                        if (bundleDoc.document) {
                            documentKeys = documentKeys.add(documentKey);
                        }
                        documentMap = documentMap.insert(documentKey, bundleConverter.toMaybeDocument(bundleDoc));
                    ...
                    return [4 /*yield*/, allocateTarget(localStoreImpl, umbrellaTarget(bundleName))];
                case 1:
                    umbrellaTargetData = _e.sent();
                    return [2 /*return*/, localStoreImpl.persistence.runTransaction('Apply bundle documents', 'readwrite', function (txn) {
                            return populateDocumentChangeBuffer(txn, documentBuffer, documentMap, SnapshotVersion.min(), versionMap)
                                ...
                                return localStoreImpl.targetCache
                                    ...
                                    .next(function () { return localStoreImpl.localDocuments.getLocalViewOfDocuments(txn, changedDocs); });
                            });
                        })];
            }
        });
 ...
 */
function hasNewerBundle(localStore, bundleMetadata) {
    var localStoreImpl = debugCast(localStore);
    var bundleConverter = new BundleConverter(localStoreImpl.serializer);
    var currentReadTime = bundleConverter.toSnapshotVersion(bundleMetadata.createTime);
    return localStoreImpl.persistence
 ...
 */
function saveBundle(localStore, bundleMetadata) {
    var localStoreImpl = debugCast(localStore);
 ...
 */
function getNamedQuery(localStore, queryName) {
    var localStoreImpl = debugCast(localStore);
 ...
 */
function saveNamedQuery(localStore, query, documents) {
    if (documents === void 0) { documents = documentKeySet(); }
    return tslib.__awaiter(this, void 0, void 0, function () {
        var allocated, localStoreImpl;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, allocateTarget(localStore, queryToTarget(fromBundledQuery(query.bundledQuery)))];
                case 1:
                    allocated = _e.sent();
                    localStoreImpl = debugCast(localStore);
...
function enableNetworkInternal(remoteStoreImpl) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var _i, _e, networkStatusHandler;
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    if (!canUseNetwork(remoteStoreImpl)) return [3 /*break*/, 4];
                    _i = 0, _e = remoteStoreImpl.onNetworkStatusChange;
                    _f.label = 1;
                case 1:
                    if (!(_i < _e.length)) return [3 /*break*/, 4];
                    networkStatusHandler = _e[_i];
...
function eventManagerListen(eventManager, listener) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var eventManagerImpl, query, firstListen, queryInfo, _e, e_7, firestoreError, raisedEvent, raisedEvent_1;
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
 ...
 */
function loadBundle(syncEngine, bundleReader, task) {
    var syncEngineImpl = debugCast(syncEngine);
    // eslint-disable-next-line @typescript-eslint/no-floating-promises
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    metadata = _e.sent();
                    return [4 /*yield*/, hasNewerBundle(syncEngine.localStore, metadata)];
                case 2:
                    skip = _e.sent();
                ...
                case 10:
                    ...
                    // has newer version.
                    return [4 /*yield*/, emitNewSnapsAndNotifyLocalStore(syncEngine, result.changedDocs, 
                ...
                case 11:
                    ...
                    return [4 /*yield*/, saveBundle(syncEngine.localStore, metadata)];
                case 12:
                    // Save metadata, so loading the same bundle will skip.
                    _e.sent();
...
var OnlineComponentProvider = /** @class */ (function () {
    ...
    OnlineComponentProvider.prototype.createSyncEngine = function (cfg) {
        return newSyncEngine(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, cfg.initialUser, cfg.maxConcurrentLimboResolutions, !cfg.persistenceSettings.durable ||
...
function toByteStreamReaderHelper(source, bytesPerRead) {
    ...
    var reader = {
        ...
        cancel: function () {
            return tslib.__awaiter(this, void 0, void 0, function () { return tslib.__generator(this, function (_e) {
                return [2 /*return*/];
            }); });
        },
...
function toByteStreamReader(source, bytesPerRead) {
    if (!(source instanceof Uint8Array)) {
        throw invalidClassError('NodePlatform.toByteStreamReader', 'Uint8Array', 1, source);
    }
 ...
 */
var BundleReader = /** @class */ (function () {
    ...
    BundleReader.fromBundleSource = function (source, serializer) {
        return new BundleReader(toByteStreamReader(source, BYTES_PER_READ), serializer);
    };
    BundleReader.prototype.close = function () {
        return this.reader.cancel();
    };
    /**
     * Returns the metadata of the bundle.
     */
    BundleReader.prototype.getMetadata = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_e) {
     ...
     */
    BundleReader.prototype.nextElement = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0: 
     ...
     * the stream.
     */
    BundleReader.prototype.nextElementImpl = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
    ...
    BundleReader.prototype.indexOfOpenBracket = function () {
     ...
     */
    BundleReader.prototype.readLength = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
     ...
     */
    BundleReader.prototype.readJsonString = function (length) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var done, result;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
    ...
    BundleReader.prototype.raiseError = function (message) {
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.reader.cancel();
     ...
     */
    BundleReader.prototype.pullMoreDataToBuffer = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
...
var FirestoreClient = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        this.asyncQueue.enqueueAndForget(function () { return readDocumentFromCache(_this.localStore, docKey, deferred); });
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        deferred = new Deferred();
                        this.asyncQueue.enqueueAndForget(function () { return readDocumentViaSnapshotListener(_this.eventMgr, _this.asyncQueue, key, options, deferred); });
                        return [2 /*return*/, deferred.promise];
                }
            });
        });
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        deferred = new Deferred();
                        this.asyncQueue.enqueueAndForget(function () { return executeQueryFromCache(_this.localStore, query, deferred); });
                        return [2 /*return*/, deferred.promise];
                }
            });
        });
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.sent();
                        deferred = new Deferred();
                        this.asyncQueue.enqueueAndForget(function () { return executeQueryViaSnapshotListener(_this.eventMgr, _this.asyncQueue, query, options, deferred); });
                        return [2 /*return*/, deferred.promise];
                }
            });
        });
    ...
    FirestoreClient.prototype.loadBundle = function (data, resultTask) {
        var _this = this;
        this.verifyNotTerminated();
        var reader = createBundleReader(data, newSerializer(this.databaseInfo.databaseId));
        this.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
            return tslib.__generator(this, function (_e) {
                loadBundle(this.syncEngine, reader, resultTask);
                return [2 /*return*/, resultTask.catch(function (e) {
                        logWarn(LOG_TAG$a, "Loading bundle failed with " + e);
                    })];
            });
        }); });
    };
    FirestoreClient.prototype.getNamedQuery = function (queryName) {
        this.verifyNotTerminated();
...
var _BaseFieldPath = /** @class */ (function () {
    function _BaseFieldPath(fieldNames) {
...
// Use underscore prefix to hide this class from our Public API.
// eslint-disable-next-line @typescript-eslint/naming-convention
var _DocumentKeyReference = /** @class */ (function () {
    function _DocumentKeyReference(_databaseId, _key, _converter) {
        this._databaseId = _databaseId;
        this._key = _key;
        this._converter = _converter;
    }
    return _DocumentKeyReference;
}());
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        this.ensureClientConfigured();
                        return [4 /*yield*/, this._firestoreClient.getNamedQuery(name)];
                    case 1:
                        namedQuery = _e.sent();
                        if (!namedQuery) {
                            return [2 /*return*/, null];
                        }
                        return [2 /*return*/, new Query(namedQuery.query, this, null)];
                }
            });
        });
    };
...
var CollectionReference = /** @class */ (function (_super) {
    ...
    CollectionReference.prototype.add = function (value) {
        ...
        return new DocumentReference(docRef._key, this.firestore, null)
            .set(convertedValue)
...
var version$1 = "1.18.0-alpha.96ae6a5fe";
/**
 * @license
 * Copyright 2020 Google LLC
 *
