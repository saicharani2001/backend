...
/**
     ...
     * limitations under the License.
     */
const A=function(){const e=S(I);e.SDK_VERSION=e.SDK_VERSION+"_LITE";const t=e.INTERNAL.registerComponent;return e.INTERNAL.registerComponent=function(e){if("PUBLIC"===e.type&&"performance"!==e.name&&"installations"!==e.name)throw Error(name+" cannot register with the standalone perf instance");return t(e)},e}();function N(e){return Array.prototype.slice.call(e)}function O(e){return new Promise((function(t,n){e.onsuccess=function(){t(e.result)},e.onerror=function(){n(e.error)}}))}function C(e,t,n){var r,i=new Promise((function(i,o){O(r=e[t].apply(e,n)).then(i,o)}));return i.request=r,i}function k(e,t,n){var r=C(e,t,n);return r.then((function(e){if(e)return new M(e,r.request)}))}function D(e,t,n){n.forEach((function(n){Object.defineProperty(e.prototype,n,{get:function(){return this[t][n]},set:function(e){this[t][n]=e}})}))}function R(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return C(this[t],r,arguments)})}))}function L(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return this[t][r].apply(this[t],arguments)})}))}function P(e,t,n,r){r.forEach((function(r){r in n.prototype&&(e.prototype[r]=function(){return k(this[t],r,arguments)})}))}function j(e){this._index=e}function M(e,t){this._cursor=e,this._request=t}function $(e){this._store=e}function B(e){this._tx=e,this.complete=new Promise((function(t,n){e.oncomplete=function(){t()},e.onerror=function(){n(e.error)},e.onabort=function(){n(e.error)}}))}function F(e,t,n){this._db=e,this.oldVersion=t,this.transaction=new B(n)}function U(e){this._db=e}!function(e,t){e.INTERNAL.registerComponent(new s("platform-logger",(e=>new T(e)),"PRIVATE")),e.registerVersion(w,"0.6.11-alpha.96ae6a5fe",t),e.registerVersion("fire-js","")}(A,"lite"),D(j,"_index",["name","keyPath","multiEntry","unique"]),R(j,"_index",IDBIndex,["get","getKey","getAll","getAllKeys","count"]),P(j,"_index",IDBIndex,["openCursor","openKeyCursor"]),D(M,"_cursor",["direction","key","primaryKey","value"]),R(M,"_cursor",IDBCursor,["update","delete"]),["advance","continue","continuePrimaryKey"].forEach((function(e){e in IDBCursor.prototype&&(M.prototype[e]=function(){var t=this,n=arguments;return Promise.resolve().then((function(){return t._cursor[e].apply(t._cursor,n),O(t._request).then((function(e){if(e)return new M(e,t._request)}))}))})})),$.prototype.createIndex=function(){return new j(this._store.createIndex.apply(this._store,arguments))},$.prototype.index=function(){return new j(this._store.index.apply(this._store,arguments))},D($,"_store",["name","keyPath","indexNames","autoIncrement"]),R($,"_store",IDBObjectStore,["put","add","delete","clear","get","getAll","getKey","getAllKeys","count"]),P($,"_store",IDBObjectStore,["openCursor","openKeyCursor"]),L($,"_store",IDBObjectStore,["deleteIndex"]),B.prototype.objectStore=function(){return new $(this._tx.objectStore.apply(this._tx,arguments))},D(B,"_tx",["objectStoreNames","mode"]),L(B,"_tx",IDBTransaction,["abort"]),F.prototype.createObjectStore=function(){return new $(this._db.createObjectStore.apply(this._db,arguments))},D(F,"_db",["name","version","objectStoreNames"]),L(F,"_db",IDBDatabase,["deleteObjectStore","close"]),U.prototype.transaction=function(){return new B(this._db.transaction.apply(this._db,arguments))},D(U,"_db",["name","version","objectStoreNames"]),L(U,"_db",IDBDatabase,["close"]),["openCursor","openKeyCursor"].forEach((function(e){[$,j].forEach((function(t){e in t.prototype&&(t.prototype[e.replace("open","iterate")]=function(){var t=N(arguments),n=t[t.length-1],r=this._store||this._index,i=r[e].apply(r,t.slice(0,-1));i.onsuccess=function(){n(i.result)}})}))})),[j,$].forEach((function(e){e.prototype.getAll||(e.prototype.getAll=function(e,t){var n=this,r=[];return new Promise((function(i){n.iterateCursor(e,(function(e){e?(r.push(e.value),void 0===t||r.length!=t?e.continue():i(r)):i(r)}))}))})}));const x="0.4.17-alpha.96ae6a5fe",q=1e4,V="w:"+x,H="FIS_v2",K=36e5,z=new r("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function W(e){return e instanceof n&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return A.registerVersion("firebase","7.22.1-alpha.96ae6a5fe","lite"),A}));
